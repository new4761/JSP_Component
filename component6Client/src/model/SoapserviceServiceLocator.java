...
public class SoapserviceServiceLocator extends org.apache.axis.client.Service implements model.SoapserviceService {
    ...
    private java.lang.String Soapservice_address = "http://localhost:8080/Component/services/Soapservice";
    ...
    public model.Soapservice getSoapservice(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            model.SoapserviceSoapBindingStub _stub = new model.SoapserviceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (model.Soapservice.class.isAssignableFrom(serviceEndpointInterface)) {
                model.SoapserviceSoapBindingStub _stub = new model.SoapserviceSoapBindingStub(new java.net.URL(Soapservice_address), this);
                _stub.setPortName(getSoapserviceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://model", "SoapserviceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://model", "Soapservice"));
        }
